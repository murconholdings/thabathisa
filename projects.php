...
<meta charset="utf-8">
    ...
    <script src="js/FF-cash.js" type="text/javascript"></script>
      <script src="js/Sendmassage.js" language="JavaScript" type="text/javascript">
                    ...
                    <div class="main">
                        <nav class="indent-left">
                            <ul class="menu wrapper">
                                ...
                                <li class="active"><a href="projects.php">our projects</a></li>
                            ...
                            <article class="col-full">
                                ...
                                <div class="wrapper p3">
                                	<article class="col-1-3">
										<div class="wrap-col">
                                    	<h4 class="p2">Company Registration (CIPC)</h4>
                                        <figure><a ><img class="img-border" src="images/page4-img1.jpg" alt="" /></a></figure>
                                        <div class="box">
                                            <div id="hideCo"><p>--More---</p></div>
                                        	<div class="padding">
                                                    <a id="moreCo">Read more</a>
                                                 <script type="text/javascript">
                                                  $(document).ready(function () {
                                                $('#hideCo').hide();
                                                $('#moreCo').click(function () {
                                                    $('#hideCo').slideToggle('slow');
                                                });
                                    ...
                                    <article class="col-1-3">
										<div class="wrap-col">                                  	
                                            <h4 class="p2">Accounting and taxation</h4>
                                            <figure><a ><img class="img-border" src="images/page4-img2.jpg" alt="" /></a></figure>
                                            <div class="box">
                                                <div id="accountHide"> <p>--more details--</p></div>
                                                <div class="padding">
                                                    <a id="moreAcc" >Read more</a>
                                                    <script type="text/javascript">
                                                  $(document).ready(function () {
                                                $('#accountHide').hide();
                                                $('#moreAcc').click(function () {
                                                    $('#accountHide').slideToggle('slow');
                                                });
                                    ...
                                    <article class="col-1-3">
                                    	<div class="wrap-col">
                                            <h4 class="p2">SARS </h4>
                                            <figure><a ><img class="img-border" src="images/page4-img3.jpg" alt="" /></a></figure>
                                            <div class="box">
                                                <div id="hideSars"><p>--More--</p></div>
                                                <div class="padding">
                                                    <a id="moreSars">Read more</a>
                                                     <script type="text/javascript">
                                                  $(document).ready(function () {
                                                $('#hideSars').hide();
                                                $('#moreSars').click(function () {
                                                    $('#hideSars').slideToggle('slow');
                                                });
                                ...
                                <div class="wrapper">
                                	<article class="col-1-3">
										<div class="wrap-col">
                                    	<h4 class="p2">Tutorial of Financial Accounting</h4>
                                        <figure><a><img class="img-border" src="images/page4-img4.jpg" alt="" /></a></figure>
                                        <div class="box">
                                            <div id="hideTF"><p></p></div>
                                        	<div class="padding">
                                                    <a id="moreTF">Read more</a>
                                                 <script type="text/javascript">
                                                  $(document).ready(function () {
                                                $('#hideTF').hide();
                                                $('#moreTF').click(function () {
                                                    $('#hideTF').slideToggle('slow');
                                                });
                                    ...
                                    <article class="col-1-3">
                                    	<div class="wrap-col">
                                            <h4 class="p2">Internet Services (Internet Cafe , online CV)</h4>
                                            <figure><a><img class="img-border" src="images/page4-img5.jpg" alt="" /></a></figure>
                                            <div class="box">
                                                <div id="hideIS"><p>--More--</p></div>
                                                <div class="padding">
                                                    <a id="moreIS">Read more</a>
                                                     <script type="text/javascript">
                                                  $(document).ready(function () {
                                                $('#hideIS').hide();
                                                $('#moreIS').click(function () {
                                                    $('#hideIS').slideToggle('slow');
                                                });
                                    ...
                                    <article class="col-1-3">
                                    	<div class="wrap-col">
                                            <h4 class="p2">Placement of unemployed youth's</h4>
                                            <figure><a><img class="img-border" src="images/page4-img6.jpg" alt="" /></a></figure>
                                            <div class="box">
                                                <div id="hidePU"><p></p></div>
                                                <div class="padding">
                                                    <a id="morePU">Read more</a>
                                                     <script type="text/javascript">
                                                  $(document).ready(function () {
                                                $('#hidePU').hide();
                                                $('#morePU').click(function () {
                                                    $('#hidePU').slideToggle('slow');
                                                });
    ...
    ?>
      ...
      <form id="contact-form" method="post">
                        ...
                        <article class="col-1-3">
                            ...
                            <p class="p1"><a class="link" target="_blank" href="http://www.murconholdings.com/" rel="nofollow">Web Site Design</a> by Murcon IT Solution</p>
