                    ...
                    <div class="main">
                        <nav class="indent-left">
                            <ul class="menu wrapper">
                                ...
                                <li class="active"><a href="company.php">our Company</a></li>
                        ...
                        <div class="wrapper">
                            <article class="col-1-3">
                                ...
                                <div class="wrapper indent-bot2">
                                    ...
                                    <div class="extra-wrap">
                                        <span class="text-2">Manager</span>
                                        <h4 class="p1">Xoliswa</h4>
                                       --content--
                                    </div>
                                </div>
                                <div class="wrapper indent-bot2">
                                    ...
                                    <div class="extra-wrap">
                                        <span class="text-2">IT Specialist</span>
                                        <h4 class="p1">Jabulani</h4>
                                       ---content--
                                    </div>
                                </div>
                                <div class="wrapper">
                                ...
                                <div class="wrapper indent-bot">
                                	<article class="col-1-2">
										<div class="wrap-col">                                   	
                                            ...
                                            <h4 class="p1">--Heading---</h4>
                                            <p><em><a href="thabathisaservices.docx" download="thabathisaservicesCompanyProfile.docx"><img src="images/word-icon.png" alt="" height="20" width="20"/>Click to Download</a> Our company profile</em></p>   
                                            <p><a href="popup.php">click</a></p>
										</div>
                                    </article>
                                    <article class="col-1-2">
										<div class="wrap-col">
